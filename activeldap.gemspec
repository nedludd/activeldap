...
Gem::Specification.new do |s|
  ...
  s.test_files = ["test/test_validation.rb", "test/test_usermod.rb", "test/test_usermod-lang-add.rb", "test/test_usermod-binary-del.rb", "test/test_usermod-binary-add.rb", "test/test_usermod-binary-add-time.rb", "test/test_userls.rb", "test/test_userdel.rb", "test/test_useradd.rb", "test/test_useradd-binary.rb", "test/test_user_password.rb", "test/test_user.rb", "test/test_syntax.rb", "test/test_schema.rb", "test/test_reflection.rb", "test/test_object_class.rb", "test/test_lpasswd.rb", "test/test_load.rb", "test/test_ldif.rb", "test/test_groupmod.rb", "test/test_groupls.rb", "test/test_groupdel.rb", "test/test_groupadd.rb", "test/test_find.rb", "test/test_dn.rb", "test/test_connection_per_dn.rb", "test/test_connection_per_class.rb", "test/test_connection.rb", "test/test_configuration.rb", "test/test_callback.rb", "test/test_bind.rb", "test/test_base_per_instance.rb", "test/test_base.rb", "test/test_attributes.rb", "test/test_associations.rb", "test/test_adapter.rb", "test/test_acts_as_tree.rb"]
